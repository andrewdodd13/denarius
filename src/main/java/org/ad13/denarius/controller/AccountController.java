...
public class AccountController {
    ...
    public long createAccount(@RequestBody AccountDTO account) {
        ...
        // Marshall the Account DTO 
        Account marshalledAccount = null;
        marshalledAccount = accountService.createAccount(marshalledAccount);
        return marshalledAccount.getAccountId();
    }
